...
func (sdk *HarryPotterSDK) OptionsMap() map[string]any {
...
func (sdk *HarryPotterSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HarryPotterSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HarryPotterSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HarryPotterSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HarryPotterSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HarryPotterSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HarryPotterSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HarryPotterSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HarryPotterSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HarryPotterSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
