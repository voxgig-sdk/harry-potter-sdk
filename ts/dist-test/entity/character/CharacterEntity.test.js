...
function basicSetup(extra) {
    ...
    let idmap = transform(['character01', 'character02', 'character03', 'house01', 'house02', 'house03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
