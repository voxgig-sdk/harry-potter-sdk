...
(0, node_test_1.describe)('CharacterEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set HARRY_POTTER_TEST_CHARACTER_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['HARRY_POTTER_TEST_CHARACTER_ENTID'];
