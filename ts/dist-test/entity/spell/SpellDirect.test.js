...
(0, node_test_1.describe)('SpellDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HarryPotterSDK({
    ...
    (0, node_test_1.test)('direct-list-spell', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-spell', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HARRY_POTTER_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HarryPotterSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['HARRY_POTTER_TEST_SPELL_ENTID'];
    ...
    const client = new __1.HarryPotterSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=SpellDirect.test.js.map