# HarryPotter TypeScript SDK



The TypeScript SDK for the HarryPotter API — a type-safe, entity-oriented client with full async/await support.
...
- Releases: [https://github.com/voxgig-sdk/harry-potter-sdk/releases](https://github.com/voxgig-sdk/harry-potter-sdk/releases)
...
| `tester(testopts?, sdkopts?)` | `HarryPotterSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `HarryPotterSDK.test(testopts?, sdkopts?)` | `HarryPotterSDK` | Create a test-mode client. |
...
| `client` | `client(): HarryPotterSDK` | Return the parent SDK client. |
...
harry-potter/
├── src/
│   ├── HarryPotterSDK.ts        # Main SDK class
