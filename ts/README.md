...
The TypeScript SDK for the HarryPotter API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new HarryPotterSDK({ apikey: '...' })
