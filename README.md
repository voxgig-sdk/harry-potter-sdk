...
Learn more about Harry Potter API at [hp-api.onrender.com](https://hp-api.onrender.com).

This is an unofficial SDK for the Harry Potter public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Character and Spell — that you
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/harry-potter-sdk` | publish pending — [install from git tag](https://github.com/voxgig-sdk/harry-potter-sdk/tags) |
| Python | `voxgig-sdk-harry-potter` | publish pending — [install from git tag](https://github.com/voxgig-sdk/harry-potter-sdk/tags) |
| PHP | `voxgig-sdk/harry-potter` | publish pending — [install from git tag](https://github.com/voxgig-sdk/harry-potter-sdk/tags) |
| Golang | `github.com/voxgig-sdk/harry-potter-sdk/go` | `go get github.com/voxgig-sdk/harry-potter-sdk/go@latest` |
| Ruby | `voxgig-sdk-harry-potter` | publish pending — [install from git tag](https://github.com/voxgig-sdk/harry-potter-sdk/tags) |
| Lua | `voxgig-sdk-harry-potter` | publish pending — [install from git tag](https://github.com/voxgig-sdk/harry-potter-sdk/tags) |
| Go CLI | `github.com/voxgig-sdk/harry-potter-sdk/go-cli` | `go install github.com/voxgig-sdk/harry-potter-sdk/go-cli/cmd/harry-potter@latest` |
| Go MCP server | `github.com/voxgig-sdk/harry-potter-sdk/go-mcp` | `go get github.com/voxgig-sdk/harry-potter-sdk/go-mcp@latest` |
...
| --- | --- | --- |
| **Character** | The Character entity (list, load). | `/api/characters` |
| **Spell** | The Spell entity (list). | `/api/spells` |
...
- Upstream API: [https://hp-api.onrender.com/](https://hp-api.onrender.com/)
