...
| Ruby | `voxgig-sdk-harry-potter` | publish pending — [install from git tag](https://github.com/voxgig-sdk/harry-potter-sdk/releases) |
| Lua | `voxgig-sdk-harry-potter` | publish pending — [install from git tag](https://github.com/voxgig-sdk/harry-potter-sdk/releases) |
