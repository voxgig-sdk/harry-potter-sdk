...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/harry-potter` | `npm install @voxgig-sdk/harry-potter` |
| Python | `voxgig-sdk-harry-potter` | `pip install voxgig-sdk-harry-potter` |
| PHP | `voxgig-sdk/harry-potter` | `composer require voxgig-sdk/harry-potter` |
| Golang | `github.com/voxgig-sdk/harry-potter-sdk/go` | `go get github.com/voxgig-sdk/harry-potter-sdk/go` |
| Ruby | `voxgig-sdk-harry-potter` | `gem install voxgig-sdk-harry-potter` |
| Lua | `voxgig-sdk-harry-potter` | `luarocks install voxgig-sdk-harry-potter` |
