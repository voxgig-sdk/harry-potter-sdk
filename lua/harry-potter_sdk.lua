...
local HarryPotterSDK = {}
HarryPotterSDK.__index = HarryPotterSDK
...
HarryPotterSDK._make_feature = _make_feature


function HarryPotterSDK.new(options)
  local self = setmetatable({}, HarryPotterSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function HarryPotterSDK:options_map()
...
function HarryPotterSDK:get_utility()
  return Utility.copy(self._utility)
end


function HarryPotterSDK:get_root_ctx()
  return self._rootctx
end


function HarryPotterSDK:prepare(fetchargs)
...
function HarryPotterSDK:direct(fetchargs)
...
-- by passing it.
function HarryPotterSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function HarryPotterSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "HarryPotterSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function HarryPotterSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = HarryPotterSDK.new(sdkopts)
  sdk.mode = "test"
