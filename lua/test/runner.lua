...
function runner.env_override(m)
  local live = runner.getenv("HARRYPOTTER_TEST_LIVE")
  local override = runner.getenv("HARRYPOTTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HARRYPOTTER_TEST_EXPLAIN")
