...
function runner.env_override(m)
  local live = runner.getenv("HARRY_POTTER_TEST_LIVE")
  local override = runner.getenv("HARRY_POTTER_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("HARRY_POTTER_TEST_EXPLAIN")
