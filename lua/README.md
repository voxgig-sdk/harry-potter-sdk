...
The Lua SDK for the HarryPotter API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/harry-potter-sdk/releases)),
...
| `wand` | `table` | Information about the character's wand |
...
```
lua/
├── harry-potter_sdk.lua    -- Main SDK module
...
The main module (`harry-potter_sdk`) exports the SDK constructor
