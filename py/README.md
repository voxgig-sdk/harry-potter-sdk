# HarryPotter Python SDK



The Python SDK for the HarryPotter API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/harry-potter-sdk/releases)) or
...
```
py/
├── harrypotter_sdk.py         -- Main SDK module
