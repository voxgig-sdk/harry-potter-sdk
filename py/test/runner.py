...
class HarryPotterTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HarryPotterTestRunner.getenv("HARRYPOTTER_TEST_LIVE")
        override = HarryPotterTestRunner.getenv("HARRYPOTTER_TEST_OVERRIDE")
        ...
        explain = HarryPotterTestRunner.getenv("HARRYPOTTER_TEST_EXPLAIN")
