# HarryPotter SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HarryPotterSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HarryPotterSDK(...) and HarryPotterSDK.test(...) become
#      HarryPotterSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "harrypotter_sdk"
_SDK_CLASS = "HarryPotterSDK"
