...
from harrypotter_sdk.utility import register

# Load features
from harrypotter_sdk.feature.base_feature import HarryPotterBaseFeature
from harrypotter_sdk.features import _has_feature, _make_feature
...
class HarryPotterSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HarryPotterUtility()
        self._utility = utility

        from harrypotter_sdk.config import shared_config
    ...
    def get_utility(self):
        return HarryPotterUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HarryPotterSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from harrypotter_sdk.entity.character_entity import CharacterEntity
    ...
    def Spell(self, data=None) -> "SpellEntity":
        ...
        from harrypotter_sdk.entity.spell_entity import SpellEntity
