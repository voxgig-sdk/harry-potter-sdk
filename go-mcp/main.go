// Command HarryPotter-mcp is an MCP server exposing the HarryPotter
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HarryPotter_list  — list records of an entity
//	HarryPotter_load  — load a single record of an entity
//
