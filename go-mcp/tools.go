...
type Args struct {
	Entity string         `json:"entity" jsonschema:"character | spell"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.HarryPotterSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "harry-potter_list",
		Description: "List records from HarryPotter. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "harry-potter_load",
		Description: "Load a single record from HarryPotter. " +
...
func runOp(client *sdk.HarryPotterSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.HarryPotterSDK, name string) (sdk.HarryPotterEntity, error) {
