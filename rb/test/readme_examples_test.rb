...
#      offline in seeded test mode (HarryPotterSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HarryPotter_sdk.rb")
  SDK_CLASS = "HarryPotterSDK"
