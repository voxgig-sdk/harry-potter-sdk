...
The PHP SDK for the HarryPotter API — an entity-oriented client using PHP conventions.
...
```
php/
├── harrypotter_sdk.php          -- Main SDK class
...
The main class (`harrypotter_sdk.php`) exports the SDK class
