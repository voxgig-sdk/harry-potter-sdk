...
class CharacterEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set HARRY_POTTER_TEST_CHARACTER_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function character_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("HARRY_POTTER_TEST_CHARACTER_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["HARRY_POTTER_TEST_CHARACTER_ENTID"]);
    ...
    if ($env["HARRY_POTTER_TEST_LIVE"] === "TRUE") {
        ...
        $client = new HarryPotterSDK(Helpers::to_map($merged_opts));
    }
