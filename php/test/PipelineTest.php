...
{
    private static function utility(): HarryPotterUtility
    {
        return new HarryPotterUtility();
    }
    ...
    private static function ctx(array $over = []): HarryPotterContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new HarryPotterContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new HarryPotterOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof HarryPotterError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new HarryPotterOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = HarryPotterMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new HarryPotterOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = HarryPotterMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new HarryPotterOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = HarryPotterMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HarryPotterSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = HarryPotterMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new HarryPotterResponse([]),
            'result' => new HarryPotterResult([]),
        ]);
        [, $err] = HarryPotterMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new HarryPotterSpec([]),
            'response' => null,
            'result' => new HarryPotterResult([]),
        ]);
        [, $err] = HarryPotterMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new HarryPotterSpec(['step' => 's']),
            'response' => new HarryPotterResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new HarryPotterResult([]),
        ]);
        [, $err] = HarryPotterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new HarryPotterSpec(['step' => 's']),
            'response' => new HarryPotterResponse(self::resp(200, ['v' => 1])),
            'result' => new HarryPotterResult([]),
        ]);
        [, $err] = HarryPotterMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new HarryPotterSpec(['step' => 's']),
            'response' => new HarryPotterResponse(self::resp(200, ['v' => 2])),
            'result' => new HarryPotterResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        HarryPotterMakeResponse::call($ctx);
    ...
    {
        $preset = new HarryPotterResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new HarryPotterSpec([]),
            'response' => new HarryPotterResponse([]),
            'result' => new HarryPotterResult([]),
        ...
        [$got, $err] = HarryPotterMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new HarryPotterResult([])]);
        [, $err] = HarryPotterMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new HarryPotterSpec([]), 'result' => null]);
        [, $err] = HarryPotterMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HarryPotterSpec(['step' => 's']),
            'result' => new HarryPotterResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new HarryPotterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HarryPotterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new HarryPotterSpec(['step' => 's']),
            'result' => new HarryPotterResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new HarryPotterOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = HarryPotterMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new HarryPotterResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new HarryPotterSpec([]),
            'result' => new HarryPotterResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = HarryPotterMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HarryPotterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new HarryPotterError('boom', 'boom');
        $utility->fetcher = function (HarryPotterContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HarryPotterSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = HarryPotterMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (HarryPotterContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = HarryPotterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(HarryPotterResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        HarryPotterMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (HarryPotterContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new HarryPotterSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = HarryPotterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new HarryPotterResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new HarryPotterSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = HarryPotterMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = HarryPotterMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = HarryPotterMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new HarryPotterResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, HarryPotterDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new HarryPotterResult(['ok' => false])]);
        $this->expectException(HarryPotterError::class);
        HarryPotterDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new HarryPotterResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', HarryPotterMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        HarryPotterMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new HarryPotterBaseFeature();
        $b = new HarryPotterBaseFeature();
        HarryPotterFeatureAdd::call($ctx, $a);
        HarryPotterFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): HarryPotterBaseFeature
    {
        $f = new HarryPotterBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        HarryPotterFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): HarryPotterContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new HarryPotterSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = HarryPotterPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        HarryPotterPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new HarryPotterResponse(['headers' => null]),
            'result' => new HarryPotterResult([]),
        ]);
        HarryPotterResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        HarryPotterResultBody::call($ctx);
