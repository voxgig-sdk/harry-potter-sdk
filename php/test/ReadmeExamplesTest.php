...
// HarryPotter SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HarryPotterSDK::test)
...
{
    private const SDK_CLASS = 'HarryPotterSDK';
    ...
    private const SDK_BASE = 'harrypotter_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../harrypotter_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
