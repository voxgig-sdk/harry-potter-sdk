...
// HarryPotter SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class HarryPotterTestFeature extends HarryPotterBaseFeature
{
    ...
    public function init(HarryPotterContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (HarryPotterContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = HarryPotterParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (HarryPotterContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(HarryPotterContext $ctx, $op, $args): array
    {
