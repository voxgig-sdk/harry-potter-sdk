...
class HarryPotterProxyFeature extends HarryPotterBaseFeature
{
    ...
    public function init(HarryPotterContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HarryPotterContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
