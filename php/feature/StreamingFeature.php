...
// HarryPotter SDK streaming feature
...
class HarryPotterStreamingFeature extends HarryPotterBaseFeature
{
    ...
    private function _iterate(HarryPotterResult $result): \Generator
    {
    ...
    private function _streamable(HarryPotterContext $ctx): bool
    {
