...
// HarryPotter SDK telemetry feature
...
class HarryPotterTelemetryFeature extends HarryPotterBaseFeature
{
    ...
    private function _close(HarryPotterContext $ctx, bool $ok): void
    {
