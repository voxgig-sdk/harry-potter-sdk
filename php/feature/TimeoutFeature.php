...
// HarryPotter SDK timeout feature
...
class HarryPotterTimeoutFeature extends HarryPotterBaseFeature
{
    ...
    private function _with_timeout(HarryPotterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HarryPotterContext $_ctx, float $ms): void
    {
        $client = $this->client;
