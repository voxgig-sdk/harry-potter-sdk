...
// HarryPotter SDK ratelimit feature
...
class HarryPotterRatelimitFeature extends HarryPotterBaseFeature
{
    ...
    private function _acquire(HarryPotterContext $ctx): void
    {
    ...
    private function _track(HarryPotterContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
