...
// HarryPotter SDK clienttrack feature
...
class HarryPotterClienttrackFeature extends HarryPotterBaseFeature
{
    ...
    public function PostConstruct(HarryPotterContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HarryPotter-SDK';
