...
|---|---|---|
| `ts/` | @voxgig-sdk/harry-potter-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/harry-potter-sdk \
      --repository voxgig-sdk/harry-potter-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/harry-potter-sdk` shows it, and
`npm trust revoke @voxgig-sdk/harry-potter-sdk --id=<id>` removes it.
