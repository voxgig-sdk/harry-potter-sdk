...
// HarryPotter SDK utility: graphql
//
...
class HarryPotterGraphql
{
    ...
    // equivalent.
    public static function body(HarryPotterContext $ctx): mixed
    {
    ...
    public static function errors(HarryPotterContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
