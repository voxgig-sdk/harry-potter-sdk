...
// HarryPotter SDK utility: fetcher

class HarryPotterFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HarryPotterSDK/1.0)';
    ...
    public static function call(HarryPotterContext $ctx, string $fullurl, array $fetchdef): array
    {
