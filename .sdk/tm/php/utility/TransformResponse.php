...
// HarryPotter SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class HarryPotterTransformResponse
{
    public static function call(HarryPotterContext $ctx): mixed
    {
        ...
        $transform = HarryPotterHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
