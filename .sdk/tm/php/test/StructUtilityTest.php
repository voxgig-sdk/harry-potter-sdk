...
// HarryPotter SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = HarryPotterOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(HarryPotterOmni::structfix($now, Struct::undef()))
                        !== json_encode(HarryPotterOmni::structfix($val, Struct::undef()))) {
