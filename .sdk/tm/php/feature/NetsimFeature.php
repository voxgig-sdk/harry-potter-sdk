...
// HarryPotter SDK netsim feature
...
class HarryPotterNetsimFeature extends HarryPotterBaseFeature
{
    ...
    private function _simulate(HarryPotterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HarryPotterContext $ctx, array $applied): void
    {
        $client = $this->client;
