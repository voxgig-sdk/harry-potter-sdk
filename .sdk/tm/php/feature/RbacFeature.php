...
class HarryPotterRbacFeature extends HarryPotterBaseFeature
{
    ...
    private function _required(HarryPotterContext $ctx): ?string
    {
    ...
    private function _reject(HarryPotterContext $ctx, string $required): void
    {
    ...
    private function _track(HarryPotterContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
