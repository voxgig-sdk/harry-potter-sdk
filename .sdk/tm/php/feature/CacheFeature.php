...
class HarryPotterCacheFeature extends HarryPotterBaseFeature
{
    ...
    private function _through(HarryPotterContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
