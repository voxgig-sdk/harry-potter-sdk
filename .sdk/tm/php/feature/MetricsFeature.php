...
// HarryPotter SDK metrics feature
...
class HarryPotterMetricsFeature extends HarryPotterBaseFeature
{
    ...
    private function _record(HarryPotterContext $ctx, bool $ok): void
    {
