...
from projectname_sdk.core.control import HarryPotterControl
...
class HarryPotterContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, HarryPotterSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HarryPotterResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HarryPotterResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return HarryPotterError(code, msg, self)
