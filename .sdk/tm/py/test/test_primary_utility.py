...
_runner = makeRunner(TEST_JSON_FILE, HarryPotterSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = HarryPotterSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = HarryPotterSDK.test(None, setup.get('a') or {})
