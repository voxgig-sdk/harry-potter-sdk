...
AQL-driven CLI and REPL for the HarryPotter SDK. Positional arguments are
...
./harry-potter-cli load 1 character
./harry-potter-cli load '{id:1}' character
