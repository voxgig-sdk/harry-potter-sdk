...
func registerSDKWords(r *eng.Registry, client *sdk.HarryPotterSDK) {
...
func runOp(client *sdk.HarryPotterSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
